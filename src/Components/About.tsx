  ...
  return (
    <>
      ...
      <section id="About" className="about-body">
        ...
        <p className="me">
          Currently, as I pursue my Master’s, I spend my time researching,
          designing, prototyping, and coding.
        </p>
        <p className="me">
          {" "}
          When I'm not studying, I enjoy curling up with a good book or
          sketching and dreaming about traveling the world.
        </p>
      </section>
